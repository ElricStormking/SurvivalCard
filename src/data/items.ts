...
export const ITEMS: Record<ItemId, ItemDef> = {
  ...
  woodenAxe: { id: 'woodenAxe', name: 'Wooden Axe', kind: 'tool', weight: 4, description: 'Chops trees and hits slowly.', toolRole: 'axe', toolTier: 1, gatherSpeedMultiplier: 0.9 },
  ironAxe: { id: 'ironAxe', name: 'Iron Axe', kind: 'tool', weight: 5, description: 'A sharper axe that shortens lumbering time.', toolRole: 'axe', toolTier: 2, gatherSpeedMultiplier: 0.68 },
  stonePickaxe: { id: 'stonePickaxe', name: 'Stone Pickaxe', kind: 'tool', weight: 5, description: 'Mines ore and stone.', toolRole: 'pickaxe', toolTier: 1, gatherSpeedMultiplier: 0.9 },
  ironPickaxe: { id: 'ironPickaxe', name: 'Iron Pickaxe', kind: 'tool', weight: 6, description: 'A stronger pickaxe that bites through ore faster.', toolRole: 'pickaxe', toolTier: 2, gatherSpeedMultiplier: 0.68 },
  rustedSword: { id: 'rustedSword', name: 'Rusted Sword', kind: 'weapon', weight: 3, description: 'A poor blade with honest reach.' },
  ironSword: { id: 'ironSword', name: 'Iron Sword', kind: 'weapon', weight: 4, description: 'Reliable enough to channel Sword Qi.' },
